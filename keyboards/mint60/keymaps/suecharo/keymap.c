...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT( \
    ...
    KC_ESC,    MO(_FN),    KC_LALT,    KC_LGUI,    KC_SPC,                 KC_SPC,     KC_RGUI,    KC_RALT,                            KC_LEFT,     KC_DOWN,    KC_RGHT   \
  ),
  [_FN] = LAYOUT( \
    ...
    XXXXXXX,   _______,    _______,    _______,    _______,                _______,    _______,    _______,                            KC_HOME,     KC_PGDN,    KC_END    \
  )
};